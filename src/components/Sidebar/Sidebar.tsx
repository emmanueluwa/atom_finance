...
const Sidebar = () => {
  ...
  return (
    <nav className="block py-4 px-6 top-0 bottom-0 w-64 bg-white shadow-xl left-0 relative flex-row flex-nowrap md:z-10 z-9999 transition-all duration-300 ease-in-out transform md:translate-x-0 -translate-x-full">
      ...
      <div className="flex-col min-h-full px-0 flex flex-wrap items-center justify-between w-full mx-auto overflow-y-auto overflow-x-hidden">
        <div className="flex bg-white flex-col opacity-100 relative mt-4 overflow-y-auto overflow-x-hidden h-auto z-40 items-center flex-1 rounded w-full">
          <div className="md:flex-col md:min-w-full flex flex-col list-none">
            <Link
              href={`/company/${symbol}/company-profile`}
            ...
            <Link
              href={`/company/${symbol}/balance-sheet`}
              className="flex md:min-w-full text-gray-800 text-medium uppercase font-bold pt-1 pb-4 no-underline"
            >
              <FaHome />
            ...
            <Link
              href={`/company/${symbol}/cashflow-statement`}
              className="flex md:min-w-full text-gray-800 text-medium uppercase font-bold pt-1 pb-4 no-underline"
            >
              <FaHome />
